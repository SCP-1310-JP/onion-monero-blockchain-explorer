...
CurrentBlockchainStatus::load_current_emission_amount()
{
    ...
    string last_saved_emmision = sineg::read(emmision_saved_file);
...
bf::path CurrentBlockchainStatus::blockchain_path {"/home/mwo/.bitscp1310jp1/lmdb"};
...
sineg::MicroCore*  CurrentBlockchainStatus::mcore {nullptr};
}
